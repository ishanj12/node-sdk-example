...
This example application starts a hello world HTTP server on port 8085 and then uses the [ngrok Node.js SDK](https://github.com/ngrok/ngrok-javascript) (`@ngrok/ngrok`) to forward public traffic to that server. See the [SDK documentation](https://ngrok.com/docs/getting-started/javascript/) for more details. When you run it, you'll get a public URL that anyone can use to access your app.
